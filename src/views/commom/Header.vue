            ...
            <el-col :xs="8" :sm="8" :md="2" >
                <div class="user-header">
                    <el-dropdown trigger="click" menu-align="start">
                        <img src="images/b_header2.jpg" width="50px" />
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item >
        ...
        data() {
            return {
                ...
                dialogs:[
                    ...
                    {header:'images/b_header3.jpg',content:'中午一起吃个饭吧，我请客。',time:'15'},
                    {header:'images/b_header.jpg',content:'需要处理一下POP展示的白边样式。',time:'18'},
                    {header:'images/b_header2.jpg',content:'下午3点开需求会议，准时参加。',time:'24'},
                    {header:'images/b_header3.jpg',content:'晚上我开车送你回家，你请我吃晚饭。',time:'45'},
                ],
                tasks:[
